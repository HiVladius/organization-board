...
export const TaskColum = ({ title, tasks, id, onTaskClick }: TaskColumnProps) => {
  ...
  return (
    ...
    >
      ...
      <div className={`mt-3 flex flex-col gap-3 transition-all duration-200 min-h-[350px] ${
        ...
        <div className={`flex-1 min-h-[200px] border-2 border-dashed border-slate-600 rounded-lg transition-all duration-200 flex items-center justify-center ${
          isOver ? 'border-cyan-500 text-cyan-300 bg-cyan-500/10' : 'text-slate-500 hover:border-slate-500'
          ...
          {isOver ? (
            ...
            <div className="text-center">
              ...
              <div className="text-xs mt-1 opacity-70">Arrastra tareas aquí</div>
            </div>
          ) : (
